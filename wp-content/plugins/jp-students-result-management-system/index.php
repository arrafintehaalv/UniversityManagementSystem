 ...
 * Description: Simple But Powerful Students Result Management System.You can add,edit,delete,publish students result form regular wordpress admin panel. It has ajax based advance result search form, Use shortcode [jp_students_result_sc] inside post or page for searching students result.
 * Version: 1.2
 * Author: Skjoy
...
function jsrms_frontend_style() {
        wp_register_style( 'jsrms_fstyle', plugin_dir_url(__FILE__).'css/style.css', false, '1.0.1' );
        wp_enqueue_style( 'jsrms_fstyle' );
		
		wp_register_script( 'jsrms_fscript', plugin_dir_url(__FILE__).'js/scripts.js', array('jquery') );
			...
			<div class="form-row">
				...
				<?php
					...
					if(!empty($terms) &&!is_wp_error($terms)) { ?>
						<select name="exam_class" id="exam-class">
			...
			<div class="metabox-holder" id="dashboard-widgets">
				<div id="postbox-container" class="postbox-container">
					...
					<div style="overflow: hidden; padding-bottom: 10px;" class="inside">
						<ul style="list-style: outside none square; margin-left: 35px">
							...
							<li>3 Different Advanced result search form.</li>
							...
							<li>Import and Export facility.</li>
							<li>Both online and offline documentation.</li>
							<li>Translation support.</li>
							<li>Shortcode system.</li>
							<li>Setting panel and many more.</li>
						</ul>
						<p style="margin: 10px 14px;"><a title="More detail & Live Demo" target="_blank" href="http://skjoy.info/product/jp-students-result-management-system-premium" class="button button-primary">More Detail & Buy</a></p>
					</div>
					</div>
					</div>	
				</div>
